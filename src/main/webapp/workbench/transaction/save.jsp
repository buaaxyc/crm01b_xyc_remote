...
<%
    ...
    Set<Map.Entry<String, String>> entrySet = pMap.entrySet();
%>
<!DOCTYPE html>
<html>
<head>
            ...
            $("#create-customerName").typeahead({
                source: function (query, process) {
                    $.get(
                        ...
                        {"name": query},
                        function (data) {
                            //data:[{客户名称1},{2},{3}]，返回的data应是List<String>转换的JSON
                            process(data);
                        },
                        "json"
                    );
                },
                delay: 1500 //延迟1.5s自动补全
            });
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="tranForm"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-customerName" autocomplete="off"
                   placeholder="支持自动补全，输入客户不存在则新建" name="customerName">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" name="activityId" value="b8eb978c4bcd41fc82dc471634a996d1">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" name="contactsId" value="5e3ae404bbf2432692907a979eefead3">
        </div>
    </div>
